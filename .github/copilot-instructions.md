...
- DO NOT write useless readme files or "documentation" that adds no value. NO "SUMMARY FILES" unless explicitly asked. NO "NEXT STEPS" files. NO MARKDOWN FILES UNLESS I EXPLICITY ASK YOU!
  ...
  Make sure to ALWAYS fix any flagged problems before finishing your work.
  AWAYS find the most efficient way to do something as to keep the code minimal and fast.
  ALWAYS follow these rules to ensure the codebase is efficient.
